...
draft: false
image: streetview.jpg # save picture in \static\img\blogs. Acceptable formats= jpg, jpeg, or png . Your iPhone pics wont work
...
#plotting the data
graph_1 <- ggplot(yield_curve_2, aes(x=date, y=value, color=maturity))+
  geom_line()+
...
graph_2 <- ggplot(yield_curve_3, aes(x=maturity, y=value, color=year, group = date))+
  geom_line()+
...
#plotting the 
graph_3 <- ggplot(yield_curve_4, aes(x=date,y=value,color = duration))+
    geom_line()+
